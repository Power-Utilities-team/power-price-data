...
| 5 | Confirm the monthly refresh actually fires unattended. Every run to date was a manual `workflow_dispatch`; the schedule has never once triggered by itself. CORRECTED 2026-07-31 — this row said cron `0 6 2 * *`, firing 2026-08-02 06:00 UTC. The workflow says `23 7 3 * *`; it was moved in `5d9d673` on 2026-07-30, the same day this row was written. First unattended firing is **2026-08-03 07:23 UTC**, so checking the Actions tab on the 2nd would have found nothing and read as a broken cron | OPEN | Time — check the Actions tab on 3 Aug, after 07:23 UTC |
